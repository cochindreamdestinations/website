...
export default async function BusPage() {
  const res = await fetch('https://cochindreamdestinations.vercel.app/api/public/bus', {method:'GET'})
  const results = await res.json();
  const imgres = await fetch('https://cochindreamdestinations.vercel.app/api/public/bus/carousel', {method:'GET'})
